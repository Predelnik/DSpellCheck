...
std::wstring get_default_aspell_path() {
  ...
  if (ERROR_SUCCESS == ::RegOpenKeyEx(HKEY_LOCAL_MACHINE, L"SOFTWARE\\Aspell",
                                      0, KEY_READ, &h_key)) {
    if (ERROR_SUCCESS ==
        ::RegQueryValueEx(h_key, L"Path", nullptr, nullptr, reinterpret_cast<LPBYTE>(psz_path), &size))
...
bool load_aspell(const wchar_t* path_arg) {
  ...
  if (h_inst_lib != nullptr) {
    aspell_mutable_container_add =
        reinterpret_cast<PFUNC_aspell_mutable_container_add>(GetProcAddress(
            h_inst_lib, "aspell_mutable_container_add"));
    aspell_mutable_container_remove =
        reinterpret_cast<PFUNC_aspell_mutable_container_remove>(GetProcAddress(
            h_inst_lib, "aspell_mutable_container_remove"));
    aspell_mutable_container_clear =
        reinterpret_cast<PFUNC_aspell_mutable_container_clear>(GetProcAddress(
            h_inst_lib, "aspell_mutable_container_clear"));
    aspell_mutable_container_to_mutable_container =
        reinterpret_cast<PFUNC_aspell_mutable_container_to_mutable_container>(GetProcAddress(
            h_inst_lib, "aspell_mutable_container_to_mutable_container"));
    aspell_key_info_enumeration_at_end =
        reinterpret_cast<PFUNC_aspell_key_info_enumeration_at_end>(GetProcAddress(
            h_inst_lib, "aspell_key_info_enumeration_at_end"));
    aspell_key_info_enumeration_next =
        reinterpret_cast<PFUNC_aspell_key_info_enumeration_next>(GetProcAddress(
            h_inst_lib, "aspell_key_info_enumeration_next"));
    delete_aspell_key_info_enumeration =
        reinterpret_cast<PFUNC_delete_aspell_key_info_enumeration>(GetProcAddress(
            h_inst_lib, "delete_aspell_key_info_enumeration"));
    aspell_key_info_enumeration_clone =
        reinterpret_cast<PFUNC_aspell_key_info_enumeration_clone>(GetProcAddress(
            h_inst_lib, "aspell_key_info_enumeration_clone"));
    aspell_key_info_enumeration_assign =
        reinterpret_cast<PFUNC_aspell_key_info_enumeration_assign>(GetProcAddress(
            h_inst_lib, "aspell_key_info_enumeration_assign"));
    new_aspell_config =
        reinterpret_cast<PFUNC_new_aspell_config>(GetProcAddress(h_inst_lib, "new_aspell_config"));
    delete_aspell_config = reinterpret_cast<PFUNC_delete_aspell_config>(GetProcAddress(
        h_inst_lib, "delete_aspell_config"));
    aspell_config_clone = reinterpret_cast<PFUNC_aspell_config_clone>(GetProcAddress(
        h_inst_lib, "aspell_config_clone"));
    aspell_config_assign = reinterpret_cast<PFUNC_aspell_config_assign>(GetProcAddress(
        h_inst_lib, "aspell_config_assign"));
    aspell_config_error_number =
        reinterpret_cast<PFUNC_aspell_config_error_number>(GetProcAddress(
            h_inst_lib, "aspell_config_error_number"));
    aspell_config_error_message =
        reinterpret_cast<PFUNC_aspell_config_error_message>(GetProcAddress(
            h_inst_lib, "aspell_config_error_message"));
    aspell_config_error = reinterpret_cast<PFUNC_aspell_config_error>(GetProcAddress(
        h_inst_lib, "aspell_config_error"));
    aspell_config_set_extra = reinterpret_cast<PFUNC_aspell_config_set_extra>(GetProcAddress(
        h_inst_lib, "aspell_config_set_extra"));
    aspell_config_keyinfo = reinterpret_cast<PFUNC_aspell_config_keyinfo>(GetProcAddress(
        h_inst_lib, "aspell_config_keyinfo"));
    aspell_config_possible_elements =
        reinterpret_cast<PFUNC_aspell_config_possible_elements>(GetProcAddress(
            h_inst_lib, "aspell_config_possible_elements"));
    aspell_config_get_default = reinterpret_cast<PFUNC_aspell_config_get_default>(GetProcAddress(
        h_inst_lib, "aspell_config_get_default"));
    aspell_config_elements = reinterpret_cast<PFUNC_aspell_config_elements>(GetProcAddress(
        h_inst_lib, "aspell_config_elements"));
    aspell_config_replace = reinterpret_cast<PFUNC_aspell_config_replace>(GetProcAddress(
        h_inst_lib, "aspell_config_replace"));
    aspell_config_remove = reinterpret_cast<PFUNC_aspell_config_remove>(GetProcAddress(
        h_inst_lib, "aspell_config_remove"));
    aspell_config_have = reinterpret_cast<PFUNC_aspell_config_have>(GetProcAddress(
        h_inst_lib, "aspell_config_have"));
    aspell_config_retrieve = reinterpret_cast<PFUNC_aspell_config_retrieve>(GetProcAddress(
        h_inst_lib, "aspell_config_retrieve"));
    aspell_config_retrieve_list =
        reinterpret_cast<PFUNC_aspell_config_retrieve_list>(GetProcAddress(
            h_inst_lib, "aspell_config_retrieve_list"));
    aspell_config_retrieve_bool =
        reinterpret_cast<PFUNC_aspell_config_retrieve_bool>(GetProcAddress(
            h_inst_lib, "aspell_config_retrieve_bool"));
    aspell_config_retrieve_int =
        reinterpret_cast<PFUNC_aspell_config_retrieve_int>(GetProcAddress(
            h_inst_lib, "aspell_config_retrieve_int"));
    aspell_error_number = reinterpret_cast<PFUNC_aspell_error_number>(GetProcAddress(
        h_inst_lib, "aspell_error_number"));
    aspell_error_message = reinterpret_cast<PFUNC_aspell_error_message>(GetProcAddress(
        h_inst_lib, "aspell_error_message"));
    aspell_error = reinterpret_cast<PFUNC_aspell_error>(GetProcAddress(h_inst_lib, "aspell_error"));
    delete_aspell_can_have_error =
        reinterpret_cast<PFUNC_delete_aspell_can_have_error>(GetProcAddress(
            h_inst_lib, "delete_aspell_can_have_error"));
    new_aspell_speller = reinterpret_cast<PFUNC_new_aspell_speller>(GetProcAddress(
        h_inst_lib, "new_aspell_speller"));
    to_aspell_speller =
        reinterpret_cast<PFUNC_to_aspell_speller>(GetProcAddress(h_inst_lib, "to_aspell_speller"));
    delete_aspell_speller = reinterpret_cast<PFUNC_delete_aspell_speller>(GetProcAddress(
        h_inst_lib, "delete_aspell_speller"));
    aspell_speller_error_number =
        reinterpret_cast<PFUNC_aspell_speller_error_number>(GetProcAddress(
            h_inst_lib, "aspell_speller_error_number"));
    aspell_speller_error_message =
        reinterpret_cast<PFUNC_aspell_speller_error_message>(GetProcAddress(
            h_inst_lib, "aspell_speller_error_message"));
    aspell_speller_error = reinterpret_cast<PFUNC_aspell_speller_error>(GetProcAddress(
        h_inst_lib, "aspell_speller_error"));
    aspell_speller_config = reinterpret_cast<PFUNC_aspell_speller_config>(GetProcAddress(
        h_inst_lib, "aspell_speller_config"));
    aspell_speller_check = reinterpret_cast<PFUNC_aspell_speller_check>(GetProcAddress(
        h_inst_lib, "aspell_speller_check"));
    aspell_speller_add_to_personal =
        reinterpret_cast<PFUNC_aspell_speller_add_to_personal>(GetProcAddress(
            h_inst_lib, "aspell_speller_add_to_personal"));
    aspell_speller_add_to_session =
        reinterpret_cast<PFUNC_aspell_speller_add_to_session>(GetProcAddress(
            h_inst_lib, "aspell_speller_add_to_session"));
    aspell_speller_personal_word_list =
        reinterpret_cast<PFUNC_aspell_speller_personal_word_list>(GetProcAddress(
            h_inst_lib, "aspell_speller_personal_word_list"));
    aspell_speller_session_word_list =
        reinterpret_cast<PFUNC_aspell_speller_session_word_list>(GetProcAddress(
            h_inst_lib, "aspell_speller_session_word_list"));
    aspell_speller_main_word_list =
        reinterpret_cast<PFUNC_aspell_speller_main_word_list>(GetProcAddress(
            h_inst_lib, "aspell_speller_main_word_list"));
    aspell_speller_save_all_word_lists =
        reinterpret_cast<PFUNC_aspell_speller_save_all_word_lists>(GetProcAddress(
            h_inst_lib, "aspell_speller_save_all_word_lists"));
    aspell_speller_clear_session =
        reinterpret_cast<PFUNC_aspell_speller_clear_session>(GetProcAddress(
            h_inst_lib, "aspell_speller_clear_session"));
    aspell_speller_suggest = reinterpret_cast<PFUNC_aspell_speller_suggest>(GetProcAddress(
        h_inst_lib, "aspell_speller_suggest"));
    aspell_speller_store_replacement =
        reinterpret_cast<PFUNC_aspell_speller_store_replacement>(GetProcAddress(
            h_inst_lib, "aspell_speller_store_replacement"));
    delete_aspell_filter = reinterpret_cast<PFUNC_delete_aspell_filter>(GetProcAddress(
        h_inst_lib, "delete_aspell_filter"));
    aspell_filter_error_number =
        reinterpret_cast<PFUNC_aspell_filter_error_number>(GetProcAddress(
            h_inst_lib, "aspell_filter_error_number"));
    aspell_filter_error_message =
        reinterpret_cast<PFUNC_aspell_filter_error_message>(GetProcAddress(
            h_inst_lib, "aspell_filter_error_message"));
    aspell_filter_error = reinterpret_cast<PFUNC_aspell_filter_error>(GetProcAddress(
        h_inst_lib, "aspell_filter_error"));
    to_aspell_filter =
        reinterpret_cast<PFUNC_to_aspell_filter>(GetProcAddress(h_inst_lib, "to_aspell_filter"));
    delete_aspell_document_checker =
        reinterpret_cast<PFUNC_delete_aspell_document_checker>(GetProcAddress(
            h_inst_lib, "delete_aspell_document_checker"));
    aspell_document_checker_error_number =
        reinterpret_cast<PFUNC_aspell_document_checker_error_number>(GetProcAddress(
            h_inst_lib, "aspell_document_checker_error_number"));
    aspell_document_checker_error_message =
        reinterpret_cast<PFUNC_aspell_document_checker_error_message>(GetProcAddress(
            h_inst_lib, "aspell_document_checker_error_message"));
    aspell_document_checker_error =
        reinterpret_cast<PFUNC_aspell_document_checker_error>(GetProcAddress(
            h_inst_lib, "aspell_document_checker_error"));
    new_aspell_document_checker =
        reinterpret_cast<PFUNC_new_aspell_document_checker>(GetProcAddress(
            h_inst_lib, "new_aspell_document_checker"));
    to_aspell_document_checker =
        reinterpret_cast<PFUNC_to_aspell_document_checker>(GetProcAddress(
            h_inst_lib, "to_aspell_document_checker"));
    aspell_document_checker_reset =
        reinterpret_cast<PFUNC_aspell_document_checker_reset>(GetProcAddress(
            h_inst_lib, "aspell_document_checker_reset"));
    aspell_document_checker_process =
        reinterpret_cast<PFUNC_aspell_document_checker_process>(GetProcAddress(
            h_inst_lib, "aspell_document_checker_process"));
    aspell_document_checker_next_misspelling =
        reinterpret_cast<PFUNC_aspell_document_checker_next_misspelling>(GetProcAddress(
            h_inst_lib, "aspell_document_checker_next_misspelling"));
    aspell_document_checker_filter =
        reinterpret_cast<PFUNC_aspell_document_checker_filter>(GetProcAddress(
            h_inst_lib, "aspell_document_checker_filter"));
    aspell_word_list_empty = reinterpret_cast<PFUNC_aspell_word_list_empty>(GetProcAddress(
        h_inst_lib, "aspell_word_list_empty"));
    aspell_word_list_size = reinterpret_cast<PFUNC_aspell_word_list_size>(GetProcAddress(
        h_inst_lib, "aspell_word_list_size"));
    aspell_word_list_elements = reinterpret_cast<PFUNC_aspell_word_list_elements>(GetProcAddress(
        h_inst_lib, "aspell_word_list_elements"));
    delete_aspell_string_enumeration =
        reinterpret_cast<PFUNC_delete_aspell_string_enumeration>(GetProcAddress(
            h_inst_lib, "delete_aspell_string_enumeration"));
    aspell_string_enumeration_clone =
        reinterpret_cast<PFUNC_aspell_string_enumeration_clone>(GetProcAddress(
            h_inst_lib, "aspell_string_enumeration_clone"));
    aspell_string_enumeration_assign =
        reinterpret_cast<PFUNC_aspell_string_enumeration_assign>(GetProcAddress(
            h_inst_lib, "aspell_string_enumeration_assign"));
    aspell_string_enumeration_at_end =
        reinterpret_cast<PFUNC_aspell_string_enumeration_at_end>(GetProcAddress(
            h_inst_lib, "aspell_string_enumeration_at_end"));
    aspell_string_enumeration_next =
        reinterpret_cast<PFUNC_aspell_string_enumeration_next>(GetProcAddress(
            h_inst_lib, "aspell_string_enumeration_next"));
    get_aspell_module_info_list =
        reinterpret_cast<PFUNC_get_aspell_module_info_list>(GetProcAddress(
            h_inst_lib, "get_aspell_module_info_list"));
    aspell_module_info_list_empty =
        reinterpret_cast<PFUNC_aspell_module_info_list_empty>(GetProcAddress(
            h_inst_lib, "aspell_module_info_list_empty"));
    aspell_module_info_list_size =
        reinterpret_cast<PFUNC_aspell_module_info_list_size>(GetProcAddress(
            h_inst_lib, "aspell_module_info_list_size"));
    aspell_module_info_list_elements =
        reinterpret_cast<PFUNC_aspell_module_info_list_elements>(GetProcAddress(
            h_inst_lib, "aspell_module_info_list_elements"));
    get_aspell_dict_info_list = reinterpret_cast<PFUNC_get_aspell_dict_info_list>(GetProcAddress(
        h_inst_lib, "get_aspell_dict_info_list"));
    aspell_dict_info_list_empty =
        reinterpret_cast<PFUNC_aspell_dict_info_list_empty>(GetProcAddress(
            h_inst_lib, "aspell_dict_info_list_empty"));
    aspell_dict_info_list_size =
        reinterpret_cast<PFUNC_aspell_dict_info_list_size>(GetProcAddress(
            h_inst_lib, "aspell_dict_info_list_size"));
    aspell_dict_info_list_elements =
        reinterpret_cast<PFUNC_aspell_dict_info_list_elements>(GetProcAddress(
            h_inst_lib, "aspell_dict_info_list_elements"));
    aspell_module_info_enumeration_at_end =
        reinterpret_cast<PFUNC_aspell_module_info_enumeration_at_end>(GetProcAddress(
            h_inst_lib, "aspell_module_info_enumeration_at_end"));
    aspell_module_info_enumeration_next =
        reinterpret_cast<PFUNC_aspell_module_info_enumeration_next>(GetProcAddress(
            h_inst_lib, "aspell_module_info_enumeration_next"));
    delete_aspell_module_info_enumeration =
        reinterpret_cast<PFUNC_delete_aspell_module_info_enumeration>(GetProcAddress(
            h_inst_lib, "delete_aspell_module_info_enumeration"));
    aspell_module_info_enumeration_clone =
        reinterpret_cast<PFUNC_aspell_module_info_enumeration_clone>(GetProcAddress(
            h_inst_lib, "aspell_module_info_enumeration_clone"));
    aspell_module_info_enumeration_assign =
        reinterpret_cast<PFUNC_aspell_module_info_enumeration_assign>(GetProcAddress(
            h_inst_lib, "aspell_module_info_enumeration_assign"));
    aspell_dict_info_enumeration_at_end =
        reinterpret_cast<PFUNC_aspell_dict_info_enumeration_at_end>(GetProcAddress(
            h_inst_lib, "aspell_dict_info_enumeration_at_end"));
    aspell_dict_info_enumeration_next =
        reinterpret_cast<PFUNC_aspell_dict_info_enumeration_next>(GetProcAddress(
            h_inst_lib, "aspell_dict_info_enumeration_next"));
    delete_aspell_dict_info_enumeration =
        reinterpret_cast<PFUNC_delete_aspell_dict_info_enumeration>(GetProcAddress(
            h_inst_lib, "delete_aspell_dict_info_enumeration"));
    aspell_dict_info_enumeration_clone =
        reinterpret_cast<PFUNC_aspell_dict_info_enumeration_clone>(GetProcAddress(
            h_inst_lib, "aspell_dict_info_enumeration_clone"));
    aspell_dict_info_enumeration_assign =
        reinterpret_cast<PFUNC_aspell_dict_info_enumeration_assign>(GetProcAddress(
            h_inst_lib, "aspell_dict_info_enumeration_assign"));
    new_aspell_string_list = reinterpret_cast<PFUNC_new_aspell_string_list>(GetProcAddress(
        h_inst_lib, "new_aspell_string_list"));
    aspell_string_list_empty = reinterpret_cast<PFUNC_aspell_string_list_empty>(GetProcAddress(
        h_inst_lib, "aspell_string_list_empty"));
    aspell_string_list_size = reinterpret_cast<PFUNC_aspell_string_list_size>(GetProcAddress(
        h_inst_lib, "aspell_string_list_size"));
    aspell_string_list_elements =
        reinterpret_cast<PFUNC_aspell_string_list_elements>(GetProcAddress(
            h_inst_lib, "aspell_string_list_elements"));
    aspell_string_list_add = reinterpret_cast<PFUNC_aspell_string_list_add>(GetProcAddress(
        h_inst_lib, "aspell_string_list_add"));
    aspell_string_list_remove = reinterpret_cast<PFUNC_aspell_string_list_remove>(GetProcAddress(
        h_inst_lib, "aspell_string_list_remove"));
    aspell_string_list_clear = reinterpret_cast<PFUNC_aspell_string_list_clear>(GetProcAddress(
        h_inst_lib, "aspell_string_list_clear"));
    aspell_string_list_to_mutable_container =
        reinterpret_cast<PFUNC_aspell_string_list_to_mutable_container>(GetProcAddress(
            h_inst_lib, "aspell_string_list_to_mutable_container"));
    delete_aspell_string_list = reinterpret_cast<PFUNC_delete_aspell_string_list>(GetProcAddress(
        h_inst_lib, "delete_aspell_string_list"));
    aspell_string_list_clone = reinterpret_cast<PFUNC_aspell_string_list_clone>(GetProcAddress(
        h_inst_lib, "aspell_string_list_clone"));
    aspell_string_list_assign = reinterpret_cast<PFUNC_aspell_string_list_assign>(GetProcAddress(
        h_inst_lib, "aspell_string_list_assign"));
    new_aspell_string_map = reinterpret_cast<PFUNC_new_aspell_string_map>(GetProcAddress(
        h_inst_lib, "new_aspell_string_map"));
    aspell_string_map_add = reinterpret_cast<PFUNC_aspell_string_map_add>(GetProcAddress(
        h_inst_lib, "aspell_string_map_add"));
    aspell_string_map_remove = reinterpret_cast<PFUNC_aspell_string_map_remove>(GetProcAddress(
        h_inst_lib, "aspell_string_map_remove"));
    aspell_string_map_clear = reinterpret_cast<PFUNC_aspell_string_map_clear>(GetProcAddress(
        h_inst_lib, "aspell_string_map_clear"));
    aspell_string_map_to_mutable_container =
        reinterpret_cast<PFUNC_aspell_string_map_to_mutable_container>(GetProcAddress(
            h_inst_lib, "aspell_string_map_to_mutable_container"));
    delete_aspell_string_map = reinterpret_cast<PFUNC_delete_aspell_string_map>(GetProcAddress(
        h_inst_lib, "delete_aspell_string_map"));
    aspell_string_map_clone = reinterpret_cast<PFUNC_aspell_string_map_clone>(GetProcAddress(
        h_inst_lib, "aspell_string_map_clone"));
    aspell_string_map_assign = reinterpret_cast<PFUNC_aspell_string_map_assign>(GetProcAddress(
        h_inst_lib, "aspell_string_map_assign"));
    aspell_string_map_empty = reinterpret_cast<PFUNC_aspell_string_map_empty>(GetProcAddress(
        h_inst_lib, "aspell_string_map_empty"));
    aspell_string_map_size = reinterpret_cast<PFUNC_aspell_string_map_size>(GetProcAddress(
        h_inst_lib, "aspell_string_map_size"));
    aspell_string_map_elements =
        reinterpret_cast<PFUNC_aspell_string_map_elements>(GetProcAddress(
            h_inst_lib, "aspell_string_map_elements"));
    aspell_string_map_insert = reinterpret_cast<PFUNC_aspell_string_map_insert>(GetProcAddress(
        h_inst_lib, "aspell_string_map_insert"));
    aspell_string_map_replace = reinterpret_cast<PFUNC_aspell_string_map_replace>(GetProcAddress(
        h_inst_lib, "aspell_string_map_replace"));
    aspell_string_map_lookup = reinterpret_cast<PFUNC_aspell_string_map_lookup>(GetProcAddress(
        h_inst_lib, "aspell_string_map_lookup"));
    aspell_string_pair_enumeration_at_end =
        reinterpret_cast<PFUNC_aspell_string_pair_enumeration_at_end>(GetProcAddress(
            h_inst_lib, "aspell_string_pair_enumeration_at_end"));
    aspell_string_pair_enumeration_next =
        reinterpret_cast<PFUNC_aspell_string_pair_enumeration_next>(GetProcAddress(
            h_inst_lib, "aspell_string_pair_enumeration_next"));
    delete_aspell_string_pair_enumeration =
        reinterpret_cast<PFUNC_delete_aspell_string_pair_enumeration>(GetProcAddress(
            h_inst_lib, "delete_aspell_string_pair_enumeration"));
    aspell_string_pair_enumeration_clone =
        reinterpret_cast<PFUNC_aspell_string_pair_enumeration_clone>(GetProcAddress(
            h_inst_lib, "aspell_string_pair_enumeration_clone"));
    aspell_string_pair_enumeration_assign =
        reinterpret_cast<PFUNC_aspell_string_pair_enumeration_assign>(GetProcAddress(
            h_inst_lib, "aspell_string_pair_enumeration_assign"));

    if (new_aspell_config == nullptr) // TODO: Add check for all used functions
      return false;
