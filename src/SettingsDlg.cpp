    ...
    case WM_INITDIALOG:
        {
            ...
            m_window_vector.push_back(
                DlgInfo(&m_simple_dlg, TEXT("Simple"), TEXT("Simple Options")));
            m_window_vector.push_back(DlgInfo(
                &m_advanced_dlg, TEXT("Advanced"), TEXT("Advanced Options")));
